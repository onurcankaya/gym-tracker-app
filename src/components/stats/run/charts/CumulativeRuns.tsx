  ...
  return (
    <Card className="w-full min-h-80 py-4 sm:py-5">
      <CardHeader className="px-4 sm:px-6">
        <CardTitle className="text-sm sm:text-md">Cumulative Runs</CardTitle>
      </CardHeader>
      ...
      {error ? (
        <CardContent className="flex flex-1 flex-col items-center justify-center px-3.5 sm:px-4">
          <p className="p-8 text-sm text-center text-red-500">
            Error loading cumulative runs chart
          </p>
          <Button
            variant="outline"
            size="sm"
        ...
        <CardContent className="flex flex-1 flex-col items-center justify-center px-3.5 sm:px-4">
          {isLoading ? (
            ...
            <LineChart
              chartData={chartData}
              lineData={[
                { key: 'cumulative runs', color: workoutColors['run'] },
              ]}
              xAxisDataKey="date"
            />
          )}
